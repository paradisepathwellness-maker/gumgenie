 ...
 * - ShaderMaterial + mouse-driven point light.
 * - Designed as a full-bleed background layer.
 */
export function GenerativeMountainScene() {
  ...
  useEffect(() => {
    ...
    return () => {
      ...
      if (currentMount && renderer.domElement.parentNode === currentMount) currentMount.removeChild(renderer.domElement);
      geometry.dispose();
      material.dispose();
      renderer.dispose();
    };
